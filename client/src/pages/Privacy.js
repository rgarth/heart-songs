// client/src/pages/Privacy.js - Complete Privacy Policy for YouTube API Compliance
              ...
              <div className="prose max-w-none">
                ...
                <div className="space-y-6 text-silver/90 leading-relaxed">
                  ...
                  <section className="mb-8">
                    ...
                    <h3 className="text-lg font-semibold text-electric-purple mb-2">7.3 Third-Party Cookies</h3>
                    <p className="mb-3">
                      When you use YouTube features within our Service, YouTube (Google) may place cookies on your device. These cookies are governed by Google's Privacy Policy. We do not have access to or control over these cookies.
                    </p>
                    
                    <h3 className="text-lg font-semibold text-electric-purple mb-2">7.4 Cookie Control</h3>
                    <p className="mb-3">
                      Most web browsers allow you to control cookies through their settings preferences. However, if you limit the ability of websites to set cookies, you may affect the functionality of our Service.
                    </p>
                  </section>
                  ...
                  <section className="mb-8">
                    <h2 className="text-xl font-bold text-turquoise mb-3">10. International Data Transfers</h2>
                    <p className="mb-3">
                      We may process and store your information on servers located in various countries, including outside your country of residence. By using our Service, you consent to the transfer of your information to countries outside your country of residence, which may have different data protection rules.
                    </p>
                  </section>
                  
                  <section className="mb-8">
                    <h2 className="text-xl font-bold text-turquoise mb-3">11. Changes to This Privacy Policy</h2>
                    <p className="mb-3">
                  ...
                  <section className="mb-8">
                    <h2 className="text-xl font-bold text-turquoise mb-3">12. Contact Us</h2>
                    <p className="mb-3">
